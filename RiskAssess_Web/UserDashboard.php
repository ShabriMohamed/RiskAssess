...
<head>
    <meta charset="UTF-8">
    <title>User Dashboard - RiskAssess</title>
...
<div class="dashboard-wrapper">
    ...
    <nav class="sidebar shadow-sm">
        ...
        <a href="#" class="nav-link active" data-page="user_overview.php"><i class="fa-solid fa-house"></i> Dashboard</a>
        <a href="#" class="nav-link" data-page="user_profile.php"><i class="fa-solid fa-user"></i> Profile</a>
        <a href="#" class="nav-link" data-page="user_appointments.php"><i class="fa-solid fa-calendar-check"></i> My Appointments</a>
    ...
    <main class="main-content" id="mainContent">
        ...
        <div class="welcome-box">
            ...
            <div>
                <div style="font-size:1.2rem;font-weight:500;">Your RiskAssess dashboard</div>
                <div style="color:#555;">Manage your counselling appointments and personal information here.</div>
            </div>
        </div>
